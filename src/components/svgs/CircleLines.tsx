...
export default function CircleLines(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          id="SvgjsLinearGradient3038"
        >
          <stop
            stop-opacity=" 1"
            stop-color="rgba(89, 13, 34)"
            offset="0.008984375"
          />
          <stop
            stop-opacity=" 1"
            stop-color="rgba(255, 77, 109)"
            offset="0.503984375"
          />
          <stop stop-opacity=" 1" stopColor="rgba(255, 204, 213)" offset="1" />
        </linearGradient>
      </defs>
    </svg>
  );
