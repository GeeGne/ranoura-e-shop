...
export default function FlowerLines(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <path
        ...
        fill='url("#SvgjsLinearGradient3053")'
      ></path>
      <defs>
        <linearGradient
          gradientTransform="rotate(0 0.5 0.5)"
          id="SvgjsLinearGradient3053"
        >
          <stop
            stopOpacity=" 1"
            stopColor="rgba(89, 13, 34)"
            offset="0.008984375"
          ></stop>
          <stop
            stopOpacity=" 1"
            stopColor="rgba(255, 77, 109)"
            offset="0.503984375"
          ></stop>
          <stop
            stopOpacity=" 1"
            stopColor="rgba(255, 204, 213)"
            offset="1"
          ></stop>
        </linearGradient>
      </defs>
