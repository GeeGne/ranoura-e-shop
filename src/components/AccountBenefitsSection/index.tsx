...
export default function AccountBenefitsSection ({ className, ...props }: Props) {
  return (
    ...
    >
      ...
      >
        <Card 
          svg={<CloudStorage className="w-12 h-auto text-content" />}
        ...
        />
        <Card 
          svg={<Location className="w-12 h-auto text-content" />}
        ...
        />
        <Card 
          svg={<Date className="w-12 h-auto text-content" />}
        ...
        />
        <Card 
          svg={<Notification className="w-12 h-auto text-content" />}
        ...
        />
        <Card 
          svg={<OfferSvg className="w-12 h-auto text-content" />}
