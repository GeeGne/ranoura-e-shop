...
import AddCategoryWindow from '@/components/fixedLayouts/AddCategoryWindow';
...
import CheckoutSuccessWindow from '@/components/fixedLayouts/CheckoutSuccessWindow';
